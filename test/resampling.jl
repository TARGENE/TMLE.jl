...
@testset "Test CausalStratifiedCV" begin
    ...
    Ψ = ATE(outcome = :Y_bin, treatment_values = (T1 = (case = 1, control = 0),))
    ...
    @test stratification_col ==
          ["0_1_", "1_0_", "0_1_", "0_1_", "0_0_", "1_1_", "missing_1_"]
    ...
    TMLE.aggregate_features!(stratification_col, resampling.treatment_variables, X)
    @test stratification_col ==
          ["0_0_", "1_1_", "0_1_", "0_0_", "0_0_", "1_1_", "missing_0_"]
