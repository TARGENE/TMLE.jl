...
HypothesisTests.OneSampleTTest(Ψ̂, Ψ₀ = 0) =
    OneSampleTTest(single_dimensional_value(Ψ̂), std(Ψ̂), Ψ̂.n, Ψ₀)

HypothesisTests.OneSampleZTest(Ψ̂, Ψ₀ = 0) =
    OneSampleZTest(single_dimensional_value(Ψ̂), std(Ψ̂), Ψ̂.n, Ψ₀)
...
function significance_test(
    Ψ̂::Union{JointEstimate,ComposedEstimate},
    Ψ₀ = zeros(size(Ψ̂.estimates, 1)),
)
